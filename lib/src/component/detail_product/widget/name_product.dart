              ...
              child: InkWell(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                      color: selectedOption == '64GB' ? Colors.green : Colors.grey,
                    ),
                  ),
                  child: Text(
                    '64GB',
              ...
              child: InkWell(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(5.0),
                    border: Border.all(
                      color: selectedOption == '128GB' ? Colors.green : Colors.grey,
                    ),
                  ),
                  child: Text(
                    '128GB',
              ...
              child: InkWell(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(5.0),
                    border: Border.all(
                      color: selectedOption == '256GB' ? Colors.green : Colors.grey,
                    ),
                  ),
                  child: Text(
                    '256GB',
