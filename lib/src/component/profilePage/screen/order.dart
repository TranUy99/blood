...
import 'package:mobile_store/src/component/profilePage/screen/order_detail.dart';
                          ...
                          Row(
                            children: [
                              const SizedBox(
                                ...
                                child: Text(
                                  '1199 USD ',
                                  style: TextStyle(fontSize: 14.0, fontWeight: FontWeight.bold, color: kGreenColor),
                                ),
                              ),
                              Padding(
                                padding: const EdgeInsets.only(left: 20),
